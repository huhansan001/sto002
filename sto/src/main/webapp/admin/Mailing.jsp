			...
			<div class="content">
							...
							<div class="leftSendinput">
								...
								<div style="margin: 20px 0;color: #ee6900;border: 1px solid #ededed;">
									...
									<a class="order_address_list btn_Addressee" >
										<img src="img/order.png" width="35" height="35">
									</a>
								</div>
								<div style="margin: 20px 0;color: #ee6900;border: 0px none;">
				...
				<div class="putUser">
					<form id="Receipt">
						...
						<div class="topput">
								...
								<!--	jQuery 遮罩层 -->
									...
									<div class="Addressee">
										<div class="layui-layer-title" style="cursor: move;padding: 0;">
											<span style="display: inline-block;margin-left: 20px;">收件人信息</span>
										...
										<table class="layui-table">
											...
											<tbody>
												<tr>
													<td colspan="5" align="center">您当前还没有收件人地址信息</td>
												</tr>
	
											</tbody>
										</table>
									</div>
									<div style="margin: 15px 0;color: #ee6900;">
							...
							<div class="rightput">
								<div class="righttext">
									...
									<div>手机号码:</div>
									<div style="margin-top: 40px;">详细地址:</div>
									<div style="margin-top: 40px;">物品重量:</div>
								</div>
						...
						<div class="foontput">
							<label>预计到达时间:</label>
							<span><input id="Time" name="Time" readonly="readonly" placeholder="通过查询时效路由"></span>
