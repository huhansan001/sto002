	...
	<!--登陆  代码-->
		$(function() {
			 $(".loginBtn").click(function(){
		    	var temp=$("input[name='numMobile']").val();
		    	var temp2=$("#numPassword").val();
		         $.ajax({
		 			type:"post",
					url:"http://localhost:8080/stoMaven/login.action",
					data:"phoneNumber="+temp+"&userPass="+temp2,
					dataType:"text",
					success:function(m){
						 if(m=="ok"){
							setCookie("loginPhone",temp);
							alert(getCookie("loginPhone"));
